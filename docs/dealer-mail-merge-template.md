# Dealer Invitation - Mail Merge Template

## Mail Merge Fields
Use these placeholders in your mail merge tool (e.g. Outlook, Gmail, Mailchimp):
- `{{dealer_name}}` - Dealer company name
- `{{contact_name}}` - Contact person's name
- `{{contact_email}}` - Contact email address
- `{{region}}` - Dealer's region/area

---

## Email Template

**Subject:** Partner with Axxess Fibre - Free Router Delivery, No Contracts & Real-Time Order Tracking
...
Every client order includes free router delivery directly to the installation address - no upfront costs for your clients, no logistics headaches for your team.
...
**No Contracts**
We believe in earning your business every month. There are no lock-in contracts for dealers or clients. Flexibility and trust are at the core of how we operate.
...
- **Shipping tracking** for router deliveries

We'd love to invite you to **test the dashboard** and experience firsthand how it can streamline your fibre sales operation.
...
We're confident that once you see the platform in action, you'll appreciate the transparency and simplicity we've built into the dealer experience.
...
**Dylan Rodgers**
Axxess Dealer Partnerships
[Your Phone Number]
[Your Email]

---

*Axxess - Powered by Openserve*
*South Africa's Fibre Network*

---

## Plain Text Version (for mail merge tools that don't support HTML)
...
* Free Router Delivery - Every client order includes free router delivery directly to the installation address.
...
* No Contracts - No lock-in contracts for dealers or clients. Flexibility and trust are core to how we operate.
